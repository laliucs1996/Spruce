<%-- 
    Document   : criticsapplicationpage
    Created on : Apr 29, 2018, 2:36:18 PM
    Author     : Austin
--%>
...
<html lang = "en">
    <head>
        ...
        <title>Critics Application</title>
            ...
            <div class="container-fluid padding">
                <div class="row padding">
                    <div class="col-6 text-center mx-auto">
                        <p id="critisp">Critic’s Application: In order to apply to become a critic, you must have at least been a user for two years or more and have experience reviewing films and TV Series. In addition, you must be trustworthy.
                            Requirements:</p>
                        <ul class="text-left" style="list-style-type:disc">
                            <li>Five screenshots of reviews you deem are your best.</li>
                            <li>Live Information: your address, name, age, etc. Essentially you need to give us a resume.</li>
                            <li>Why we should choose you?</li>
                        </ul>
                        <h5>Send your e-mail to us at <a class="all-link" href="mailto:<fmt:message key="emaillink"></fmt:message>">SpruceIncorporated@gmail.com</a>!</h5>
                    </div>
                </div>
                <hr class="my-4">
            </div>
