        ...
        <body>
            ...
            <div class="container-fluid padding">
                <div class="row welcome text-center">
                    <div class="col-12">
                        <h1>STEVEN SPIELBERG MAY DIRECT DC'S BLACKHAWK, AND MORE MOVIE NEWS</h1>
                    </div>
                    <hr class="light">
                </div>
            </div>
