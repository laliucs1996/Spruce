<%-- 
    Document   : about
    Created on : Apr 29, 2018, 2:00:38 PM
    Author     : Austin
--%>
            ...
            <div class="container-fluid padding">
                <div class="row padding">
                    ...
                    <div class="col-6 text-center mx-auto">
                        <img src="images/backgroundSpruce.png"/>
                        <p id="aboutp">In a humanities’ building far far away, there was a class, CSE 308, where 4 people met together to become the spruce team to take on the challenge and succeed. Unfortunately, problems would arise and one would be lost. However, the spruce rose from the ground and grew into a mighty tree that stands upon the foundations of the Earth providing media information to the masses.
Team Spruce currently consists of Larry Liu, Stanley Chin and Xiaoming Lin creating a media rating page as a final project in their major.  This website provides information on over 2000+ movies, 500+ television Series and multiple episodes per series and provides a rating system for the movies and series in addition to numerous other features like creating lists for users and other information including celebrities and what movies they starred in (limited to the movies in the database).</p>
                    </div>
                </div>
                <hr class="my-4">
            </div>
