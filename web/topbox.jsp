    ...
    <div class="container-fluid padding">
        <div class="row padding">
            <div class="col-12">
                <div class="row padding">
                    <c:choose>
                        <c:when test="${requestScope.tvs == null}">
                                    ...
                                    <div class="row padding">
                                        ...
                                        <div class="col-7">
                                            <a href="#" class="all-link">
                                                <h4><form class="mt-3" action="DisplayMovieServlet" method="GET"><input name="movie" value="<c:out value="${result.movieID}"></c:out>" style="color:white; display:none;" /><h5><input type="submit" value="<c:out value="${result.title}"></c:out>" style="padding:0px 0px; background-color: Transparent; border:none;"></h5></form></h4>
                                            </a>
                                            <div><c:out value="${result.tagLine}"></c:out></div>
                                            <div>Release Date: <c:out value="${result.releaseDate}"></c:out></div>
                                            <c:if test="${requestScope.searchChoice == 'Top Box Office'}">
                                                <div>Revenue: $${result.revenue}</div>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <c:otherwise>
                            <c:forEach items="${requestScope.tvs}" var="result">
                                <div class="col-5 border border-secondary my-2 mx-auto">
                                    <div class="row padding">
                                        <div class="col-5">
                                            <a href="#">
                                        ...
                                        <div class="col-7">
                                            <a href="#" class="all-link">
                                                <h4><form class="mt-3" action="DisplayTVServlet" method="GET"><input name="televisionID" value="<c:out value="${result.televisionID}"></c:out>" style="color:white; display:none;" /><input name="seasonNo" value="1" style="display:none;"/><h5><input type="submit" value="<c:out value="${result.name}"></c:out>" style="padding:0px 0px; background-color: Transparent; border:none;"></h5></form></h4>
                                            </a>
